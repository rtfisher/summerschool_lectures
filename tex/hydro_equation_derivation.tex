...
\begin{marginfigure}
  ...
  \caption{Current density from a 2D MHD simulation at magnetic Reynolds number $R_m = 10^6$, showing reconnection and the formation of plasmoids \url {https://doi.org/10.1103/PhysRevLett.121.165101}.}
  \label{fig:plasmoids}
\end{marginfigure}
